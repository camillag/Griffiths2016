...
LIB_condition.favorable = ['The communicator states the following about Peter: Peter has helped many people, even when it did not benefit him. In my view, he is someone who stands up for the interests of others. I think he is socially very responsible. On the other hand, Peter said something rude to another person recently. In my opinion, he acted coldly and did something unfriendly.']
LIB_condition.unfavorable = ['The communicator states the following about Peter: Peter helped another person, even when it did not benefit him. In my view, he is someone who acted in the interests of that person, as well as stood up for the interests of that person. On the other hand, Peter is rude to many people. In my opinion, he is cold and unfriendly.']

//var totalTrialsLIB = LIB_condition.length;

//var numTrialsExperiment = totalTrialsLIB
var trials = [];

var cond = {
		sentence: LIB_condition.favorable,
...
// for (i = 0; i < totalTrialsLIB; i++) {
// 	trial = {
// 		sentence: LIB_condition[i],
...
var experiment = {
 ...
 //style="width:progressTotal%"
	    ...
	    if (trial_info.trial_type == "condition") {
	    	$("#LIB_sentence").html(trial_info.sentence);  //add sentence to html 
	    	 showSlide("LIB_slide");              //display slide
	    	 experiment.data.sentence.push(trial_info.sentence);

	    } 

	    if (trial_info.trial_type == "manipcheck") {
