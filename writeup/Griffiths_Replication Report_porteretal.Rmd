...
#condition variable
pilot1 = pilot1 %>%
  select(-1:2) %>% #removing the first two lines of the dataset, which will always be the qualtrics junk headers. 
...
I will primarily be looking at the effect size on the above effect (difference between favorable and unfavorable LIB conditions in their political ID of peter) to determine whether it was a successful replication. 
